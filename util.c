...
void printBinario(BinaryList *b, FILE *f){
	...
	while(b != NULL){
		switch(b->format){
		case 1:
			for(i = 0; i < 5; i++) fprintf(f, "%d", b->operando[i]);
			fprintf(f, "_");
		...
		case 2:
			...
			for(i = 0; i < 5; i++) fprintf(f, "%d", b->R1[i]);
			fprintf(f, "_");
			for(i = 0; i < 17; i++) fprintf(f, "%d", b->Imediato17[i]);
			fprintf(f, "\n");
			break;
		case 3:
			for(i = 0; i < 5; i++) fprintf(f, "%d", b->operando[i]);
		...
		case 4:
			...
			for(i = 0; i < 5; i++) fprintf(f, "%d", b->RD[i]);
			fprintf(f, "_");
			for(i = 0; i < 22; i++) fprintf(f, "%d", b->Imediato22[i]);
			fprintf(f, "\n");
			break;
		case 5:
			for(i = 0; i < 5; i++) fprintf(f, "%d", b->operando[i]);
			...
			for(i = 0; i < 5; i++) fprintf(f, "%d", b->RD[i]);
			fprintf(f, "_");
			fprintf(f, "0000000000000000000000");
			fprintf(f, "\n");
			break;
		case 6:
			for(i = 0; i < 5; i++) fprintf(f, "%d", b->operando[i]);
		...
		case 7:
			for(i = 0; i < 5; i++) fprintf(f, "%d", b->operando[i]);
			fprintf(f, "_");
			fprintf(f, "000000000000000000000000000");
			fprintf(f, "\n");
			break;
		default:
			break;
